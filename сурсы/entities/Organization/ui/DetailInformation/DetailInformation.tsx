...
export const DetailInformation = memo((props: PropsWithChildren<DetailInformationProps>) => {
    ...
    return (
        <div className={classNames(cls.DetailInformation,{},[className])}>
            ...
            <div className={cls.addInfo}>
                <p className={cls.addBlock}>Дополнительная информация 1....</p>
                <p className={cls.addBlock}>Дополнительная информация 2....</p>
            </div>
        </div>
    );
});
