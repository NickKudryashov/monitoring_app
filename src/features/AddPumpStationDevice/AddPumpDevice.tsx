...
export const AddPumpDevice = memo(
    (props: PropsWithChildren<AddPumpDeviceProps>) => {
        ...
        return (
            <Modal
                isOpen={isOpen}
                onClose={onClose}
                className={classNames(cls.AddPumpDevice, {}, [className])}
            >
                <div className={cls.AddPumpDevice}>
                    ...
                    >
                        ...
                        <option key={AVAILABLE_TYPE} value={AVAILABLE_TYPE}>
                            {AVAILABLE_TYPE_VERBOSE}
                        </option>
                        <option key={AVAILABLE_TYPE2} value={AVAILABLE_TYPE2}>
                            {AVAILABLE_TYPE_VERBOSE2}
                        </option>
                    </select>
                    <select
                        value={selectedObj}
                    ...
                    <button onClick={() => onClose && onClose()}>Отмена</button>
                </div>
            </Modal>
        );
    }
