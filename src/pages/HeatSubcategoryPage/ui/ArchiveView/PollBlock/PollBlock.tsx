        ...
        <VFlexBox height="85%" className={cls.PollBlock}>
            <VFlexBox className={cls.content} alignItems="center" gap="7px">
                        ...
                        {archs.map((el) => (
                            ...
                            >
                                <AppInput
                                    type="radio"
                                    checked={el === archType}
                                    onClick={() => setArchType(el)}
                                />
                                <HFlexBox
                                    className={cls.archtypeBox}
                                    height="50%"
                                    width="90%"
                                    align="center"
                                    alignItems="center"
                ...
                <VFlexBox height="45%" gap="3px" width={"85%"}>
                    <HFlexBox
                        onClick={() => setAllSettingsMode((prev) => !prev)}
                        align="space-between"
                        alignItems="center"
                    ...
                    {allSettingsMode && (
                        ...
                        >
                            ...
                            >
                                <AppInput type="checkbox" checked={mock} />
                                <p>
                                    Включить пропуск прибора при отсутствии
                                    ответа
                                </p>
                            </HFlexBox>
                            <HFlexBox
                            ...
                            >
                                <AppInput
                                    ...
                                    value={recCount}
                                    onChange={(e) =>
                                        setRecCount(Number(e.target.value))
                                    }
                                />
