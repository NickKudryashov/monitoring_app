...
import { AutomaticDeviceData } from "entities/AutomaticDevice/model/types/AutomaticDeviceTypes";

interface GeneralInfoBlockProps {
    deviceData:AutomaticDeviceData;
}
            ...
            <VFlexBox gap="10px" align="space-around" >
                ...
                <HFlexBox className={cls.generalCardItems} align="space-between">
                    <div className={cls.generalCardTextWrapper}>
                        <p>{`количество систем: ${deviceData?.system_count ?? "..."}`}</p>
                    </div>
                    <div className={cls.generalCardTextWrapper}>
                        <p>{`тип счетчика: ${deviceData?.device_type_verbose ?? "..."}`}</p>
                    </div>
                </HFlexBox>
                <HFlexBox className={cls.generalCardItems} align="space-between">
                    <div className={cls.generalCardTextWrapper}>
