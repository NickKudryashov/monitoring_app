...
import { AutomaticDeviceData, PumpParameter } from "entities/AutomaticDevice/model/types/AutomaticDeviceTypes";

interface SystemCardProps {
    params:Record<number,PumpParameter[]>;
    index:number;
}
            ...
            <VFlexBox className={cls.systemCardFlexInfoPart}>
                ...
                </p>
                {
                    params[index].map((param)=>
                        <HFlexBox height={"9%"} className={cls.paramRow} key={param.id} alignItems="end" align="space-between">
