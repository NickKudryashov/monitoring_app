    ...
    if (objects) {
        content = (
            <DetailView className={cls.detail}>
                ...
                >
                    {
                        <HFlexBox width='100%' align={isMobile ? 'space-between' : 'flex-end'}>
                            <HFlexBox onClick={showAllClearFitlerHandler} width='25%' alignItems='center'>
                            ...
                            <HFlexBox
                                ...
                                className={classNames(
                                    '',
                                    {
                                        [cls.selectedFilter]: !!searchParams.get('no_answer'),
                                    },
                                    [],
                                )}
                            >
                            ...
                            <HFlexBox
                                ...
                                className={classNames(
                                    '',
                                    {
                                        [cls.selectedFilter]: !!searchParams.get('events'),
                                    },
                                    [],
                                )}
                            >
