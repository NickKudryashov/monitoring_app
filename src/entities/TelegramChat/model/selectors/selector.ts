...
export const [useGetMessagest,getMessages] = buildSelector((state:StateSchema)=>state.chats.messages || []);
export const [useGetStop,getStop] = buildSelector((state:StateSchema)=>state.chats.stop || []);