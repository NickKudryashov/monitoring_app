...
export enum AppRoutesAuth {
    ...
    SETTINGS = 'settings',
    SUBCAT = 'subcat',
    OBJECT_EDIT_SUBCAT = 'object_subcat_edit',
...
export const RoutePathPublic: Record<AppRoutesPublic, string> = {
    ...
    [AppRoutesPublic.ACTIVATE]: '/activate/',
...
export const RoutePathAuth: Record<AppRoutesAuth, string> = {
    ...
    [AppRoutesAuth.ACTIVATE]: '/activate/',
    ...
    [AppRoutesAuth.OBJECT_EDIT_SUBCAT]: '/object_subcat_edit/',
