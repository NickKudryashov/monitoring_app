...
export const MainLayout = memo((props: PropsWithChildren<MainLayoutProps>) => {
    ...
    return (
        ...
        //     <Layout.Content>{DetailView}</Layout.Content>
        //     <Layout.Footer>
        //         <CookieConsent
        ...
        //         >
        //             Пользуясь данным веб-ресурсом вы даете согласие на использование ваших персональных данных
        //             и файлов cookies
        //         </CookieConsent>
        ...
        <div className={classNames(cls.MainLayout, {}, [className])}>
            ...
            <CookieConsent
                ...
                style={{ background: '#355EAB', opacity: 0.8 }}
            >
                Пользуясь данным веб-ресурсом вы даете согласие на использование ваших персональных данных и
                файлов cookies
            </CookieConsent>
            {!isMobile && <p className={cls.version}>{version}</p>}
        </div>
